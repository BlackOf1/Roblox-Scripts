                        ...
                        if  Mob == "Humans" and On == true  then 
                            if PotentialTarget.Name == "Human" or PotentialTarget.Name == "Athlete" and game:GetService("Players").LocalPlayer.Character ~= nil  then 
                                ...
                                pcall(function()   
                                    ...
                                    game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = Target:FindFirstChild("HumanoidRootPart").CFrame * CFrame.new(0,0,.5)
                                    warn(Target.Name)
                                    warn(Target:FindFirstChild("ClickPart").Name)
                                    fireclickdetector(Target:FindFirstChild("ClickPart"):FindFirstChildOfClass("ClickDetector"),50)
                                    fireclickdetector(Target:FindFirstChild("ClickPart"):FindFirstChildOfClass("ClickDetector"),50)
                                end)
                                wait(1.75)
                            end 
                            ...
                            if v.Name == "AggroSpawns" or v.Name == "GhoulSpawns" and game:GetService("Players").LocalPlayer.Character ~= nil then 
                                if string.match(PotentialTarget.Name,"Aogiri") then
                                    ...
                                    pcall(function()   
                                        ...
                                        warn(Target.Name)
                                        warn(Target:FindFirstChild("ClickPart").Name)
                                        warn(Target:FindFirstChild("ClickPart"):FindFirstChildOfClass("ClickDetector").Name)
                                        fireclickdetector(Target:FindFirstChild("ClickPart"):FindFirstChildOfClass("ClickDetector"),50)
                                        fireclickdetector(Target:FindFirstChild("ClickPart"):FindFirstChildOfClass("ClickDetector"),50)
                                    end)
                                    wait(1.75)
