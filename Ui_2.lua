...
function CreateNewButton(ButtonConfig, Parent)
	...
	local ButtonColor = ButtonConfig.ButtonColor or nil
	...
	ButtonLabel.TextColor3 = ButtonColor == nil and ThisTheme.ButtonAccent or ButtonColor == true and Color3.fromRGB(15, 199, 30) or ButtonColor == false and Color3.fromRGB(250, 0, 0)
...
function Material.Load(Config)
	...
	function TabLibrary.New(TabConfig)
		...
		function OptionLibrary.Dropdown(DropdownConfig)
			...
			local ColorMenu = DropdownConfig.ColorMenu or function() warn("nil dropdown") end
			...
			table.foreach(DropdownOptions, function(_, Value)
				...
				local Con 
				Con = DropdownTitle.MouseButton1Down:Connect(function()
					DropdownTitle
				end 
			end)
